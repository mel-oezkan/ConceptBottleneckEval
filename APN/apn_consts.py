...
# USE THIS LIST (indeces are based on the selected attributes only) - generated in index_translation_util.py
...
# From the part segmentation dataset
# IMPORTANT: left + right masks are joined to one
...
#   - body: take all attributes from groups back, brest and belly
...
# TODO: So this could be associated to body
CUB_GROUPS_TO_PART_SEG = {
    ...
    'body': CUB_ATTRIBUTES_PER_GROUP['back'] + CUB_ATTRIBUTES_PER_GROUP['breast'] + CUB_ATTRIBUTES_PER_GROUP['belly'],
    ...
    'tail': CUB_ATTRIBUTES_PER_GROUP['tail'],
    'wing': CUB_ATTRIBUTES_PER_GROUP['wing'],
    'leg': CUB_ATTRIBUTES_PER_GROUP['leg'],
}